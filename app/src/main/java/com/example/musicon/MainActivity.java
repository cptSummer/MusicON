...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        while (cursor.moveToNext()) {
            Drawable icon = Drawable.createFromPath(cursor.getString(1));

            AudioModel songData = new AudioModel(cursor.getString(1), cursor.getString(0), cursor.getString(2), icon, cursor.getString(3));
